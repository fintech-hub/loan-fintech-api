...
class TestViews(TestCase):
    def setUp(self) -> None:
        ...
        self.debt_client = Client.objects.create(
            name="New Felicity",
            surname="New Jones",
            email="felicity@gmail.com",
            telephone="11999661781",
        ...
        self.debt_loan = Loan.objects.create(
            client_id=self.debt_client,
            amount=1000,
            term=12,
            rate=0.05,
            date=datetime.datetime(2019, 5, 9, 3, 18, tzinfo=pytz.UTC)
        ...
        self.first_payment = Payment.objects.create(
            loan_id=self.debt_loan,
            payment_choice='made',
            date=datetime.datetime(2019, 5, 1, 4, 18, tzinfo=pytz.UTC),
            amount=85.6
        )

        self.third_payment = Payment.objects.create(
            loan_id=self.debt_loan,
